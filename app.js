...
const requireNamePannel = document.querySelector(".gameInfo__requireName");
...
exitBtn.addEventListener("click", function() {
	requireNamePannel.style.zIndex = "99";
});
// Game Difficulty Checkbox Function
function checkCheckbox() {
	if (nameInputDisplay.value === "") {
		requireNamePannel.style.zIndex = "300";
	}
	else {
		if (checkboxEasy.checked) {
			...
			for (let i = 0; i < arr.length; i++) {
				...
				if (cardSideDisplayBackTwenty[i].textContent === "1") {
					cardSideDisplayBackTwenty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape1.png)";
				}
				else if (cardSideDisplayBackTwenty[i].textContent === "2") {
					cardSideDisplayBackTwenty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape2.png)";
				}
				else if (cardSideDisplayBackTwenty[i].textContent === "3") {
					cardSideDisplayBackTwenty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape3.png)";
				}
				else if (cardSideDisplayBackTwenty[i].textContent === "4") {
					cardSideDisplayBackTwenty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape4.png)";
				}
				else if (cardSideDisplayBackTwenty[i].textContent === "5") {
					cardSideDisplayBackTwenty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape5.png)";
				}
				else if (cardSideDisplayBackTwenty[i].textContent === "6") {
					cardSideDisplayBackTwenty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape6.png)";
				}
				else if (cardSideDisplayBackTwenty[i].textContent === "7") {
					cardSideDisplayBackTwenty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape7.png)";
				}
				else if (cardSideDisplayBackTwenty[i].textContent === "8") {
					cardSideDisplayBackTwenty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape8.png)";
				}
				else if (cardSideDisplayBackTwenty[i].textContent === "9") {
					cardSideDisplayBackTwenty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape9.png)";
				}
				else if (cardSideDisplayBackTwenty[i].textContent === "10") {
					cardSideDisplayBackTwenty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape10.png)";
				}
			}
		}
			...
			for (let i = 0; i < arr2.length; i++) {
				...
				if (cardSideDisplayBackForty[i].textContent === "1") {
					...
					cardSideDisplayBackForty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape11.png)";
				}
				else if (cardSideDisplayBackForty[i].textContent === "12") {
					cardSideDisplayBackForty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape12.png)";
				}
				else if (cardSideDisplayBackForty[i].textContent === "13") {
					cardSideDisplayBackForty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape13.png)";
				}
				else if (cardSideDisplayBackForty[i].textContent === "14") {
					cardSideDisplayBackForty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape14.png)";
				}
				else if (cardSideDisplayBackForty[i].textContent === "15") {
					cardSideDisplayBackForty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape15.png)";
				}
				else if (cardSideDisplayBackForty[i].textContent === "16") {
					cardSideDisplayBackForty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape16.png)";
				}
				else if (cardSideDisplayBackForty[i].textContent === "17") {
					cardSideDisplayBackForty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape17.png)";
				}
				else if (cardSideDisplayBackForty[i].textContent === "18") {
					cardSideDisplayBackForty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape18.png)";
				}
				else if (cardSideDisplayBackForty[i].textContent === "19") {
					cardSideDisplayBackForty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape19.png)";
				}
				else if (cardSideDisplayBackForty[i].textContent === "20") {
					cardSideDisplayBackForty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape20.png)";
				}
			}
		}
			...
			for (let i = 0; i < arr3.length; i++) {
				...
				if (cardSideDisplayBackSixty[i].textContent === "1") {
					...
					cardSideDisplayBackSixty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape21.png)";
				}
				else if (cardSideDisplayBackSixty[i].textContent === "22") {
					cardSideDisplayBackSixty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape22.png)";
				}
				else if (cardSideDisplayBackSixty[i].textContent === "23") {
					cardSideDisplayBackSixty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape23.png)";
				}
				else if (cardSideDisplayBackSixty[i].textContent === "24") {
					cardSideDisplayBackSixty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape24.png)";
				}
				else if (cardSideDisplayBackSixty[i].textContent === "25") {
					cardSideDisplayBackSixty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape25.png)";
				}
				else if (cardSideDisplayBackSixty[i].textContent === "26") {
					cardSideDisplayBackSixty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape26.png)";
				}
				else if (cardSideDisplayBackSixty[i].textContent === "27") {
					cardSideDisplayBackSixty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape27.png)";
				}
				else if (cardSideDisplayBackSixty[i].textContent === "28") {
					cardSideDisplayBackSixty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape28.png)";
				}
				else if (cardSideDisplayBackSixty[i].textContent === "29") {
					cardSideDisplayBackSixty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape29.png)";
				}
				else if (cardSideDisplayBackSixty[i].textContent === "30") {
					cardSideDisplayBackSixty[i].style.backgroundImage =
						"url(https://github.com/SVDwebtech/memoryGame014/tree/master/img/shape30.png)";
				}
			}
		}
